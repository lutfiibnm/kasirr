...
import {
  ...
  Minus, Plus, Printer, QrCode, Search, Settings, ShoppingCart, Trash2,
      ...
      <div className="pos-left card">
        ...
        <div className="product-grid">
          {products.map(p => {
            ...
            let badgeText = '';
            if (p.bestSeller && p.discountPercent) {
              badgeText = `Best -${percentLabel(p.discountPercent)}%`;
            } else if (p.bestSeller && p.promo) {
              badgeText = 'Best Promo';
            } else if (p.bestSeller) {
              badgeText = 'Best';
            } else if (p.discountPercent) {
              badgeText = `-${percentLabel(p.discountPercent)}%`;
            } else if (p.promo) {
              badgeText = 'Promo';
            }
